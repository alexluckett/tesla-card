...
`,ht={S:{model:"ms",name:"Model S"},X:{model:"mx",name:"Model X"},3:{model:"m3",name:"Model 3"},Y:{model:"my",name:"Model Y"},C:{model:"ct",name:"Cybertruck"},R:{model:"mr",name:"Roadster"},T:{model:"ms",name:"Semi"},A:{model:"my",name:"Cybercab"}},dt={L:2020,M:2021,N:2022,P:2023,R:2024,S:2025,T:2026,V:2027,W:2028,X:2029,Y:2030},ut={my:{year:2025,current:"juniper",previous:"legacy"},m3:{year:2024,current:"highland",previous:"legacy"},ms:{year:2021,current:"palladium",previous:"legacy"},mx:{year:2021,current:"palladium",previous:"legacy"}},pt=new Set(["GB","IE","AU","NZ","JP","IN","ZA","SG","MY","TH","HK","ID","PK","LK","KE","CY","MT"]);function mt(t,e){const i=ut[t];return i?null===e||e>=i.year?i.current:i.previous:null}const ft=["FRONT34","STUD_3QTR","SIDE","STUD_SIDE","REAR34","STUD_REAR"],gt={my:{juniper:{label:"Model Y (2025 onwards)",trim:"$MTY86",performanceTrim:"$MTY53",interior:"$IPB12",performanceInterior:"$IPB14",paints:[{id:"stealth_grey",code:"$PN01",name:"Stealth Grey",swatch:"#494955"},{id:"pearl_white",code:"$PPSW",name:"Pearl White",swatch:"#e7e8ec"},{id:"diamond_black",code:"$PBSB",name:"Diamond Black",swatch:"#262629"},{id:"deep_blue",code:"$PPSB",name:"Deep Blue Metallic",swatch:"#113683"},{id:"ultra_red",code:"$PR01",name:"Ultra Red",swatch:"#a7111f"},{id:"quicksilver",code:"$PN00",name:"Quicksilver",swatch:"#97969f"},{id:"glacier_blue",code:"$PB01",name:"Glacier Blue",swatch:"#6e84a4"},{id:"navy_pb02",code:"$PB02",name:"Dark Blue (PB02)",swatch:"#2a3650"}],wheels:[{id:"crossflow_19",code:"$WY19P",name:'19" Crossflow'},{id:"helix_20",code:"$WY20B",name:'20" Helix 2.0'},{id:"induction_20",code:"$WY20A",name:'20" Induction'},{id:"performance_21",code:"$WY21A",name:'21" Performance',performanceOnly:!0}]},legacy:{label:"Model Y (2020 to 2024)",trim:"$MDLY,$MTY01",interior:"$INPB0",paints:[{id:"pearl_white",code:"$PPSW",name:"Pearl White",swatch:"#e7e8ec"},{id:"solid_black",code:"$PBSB",name:"Solid Black",swatch:"#262629"},{id:"midnight_silver",code:"$PMNG",name:"Midnight Silver",swatch:"#5b6065"},{id:"deep_blue",code:"$PPSB",name:"Deep Blue Metallic",swatch:"#113683"},{id:"red_multicoat",code:"$PPMR",name:"Red Multi-Coat",swatch:"#a51d2c"}],wheels:[{id:"gemini_19",code:"$WY19B",name:'19" Gemini'},{id:"induction_20",code:"$WY20P",name:'20" Induction'}]}},m3:{legacy:{label:"Model 3",trim:"$MDL3,$MT300",interior:"$IN3PB",paints:[{id:"pearl_white",code:"$PPSW",name:"Pearl White",swatch:"#e7e8ec"},{id:"solid_black",code:"$PBSB",name:"Solid Black",swatch:"#262629"},{id:"midnight_silver",code:"$PMNG",name:"Midnight Silver",swatch:"#5b6065"},{id:"deep_blue",code:"$PPSB",name:"Deep Blue Metallic",swatch:"#113683"},{id:"red_multicoat",code:"$PPMR",name:"Red Multi-Coat",swatch:"#a51d2c"}],wheels:[{id:"aero_18",code:"$W38B",name:'18" Aero'}]}}};function _t(t,e){return vt(t,e)?.wheels[0]?.id??null}function vt(t,e){const i=gt[t];return i?e&&i[e]?i[e]:Object.values(i)[0]??null:null}function yt(t,e){return null!==vt(t,e)}function $t(t,e,i=!1){const n=vt(t,e);return n?n.wheels.filter(t=>i||!t.performanceOnly):[]}function wt(t,e){return vt(t,e)?.paints??[]}const bt={FRONT34:{width:1.613,left:-.316,top:-.503,aspect:2.273},STUD_3QTR:{width:1.613,left:-.316,top:-.503,aspect:2.273},REAR34:{width:1.613,left:-.316,top:-.503,aspect:2.273},SIDE:{width:1.53,left:-.27,top:-.47,aspect:2.5},STUD_SIDE:{width:1.53,left:-.27,top:-.47,aspect:2.5},STUD_REAR:{width:1.613,left:-.316,top:-.503,aspect:2.273}};function At(t,e){return t.find(t=>t.id===e)??null}const St="tesla_fleet",xt={battery:"sensor:charge_state_battery_level",batteryUsable:"sensor:charge_state_usable_battery_level",range:"sensor:charge_state_battery_range",rangeEstimated:"sensor:charge_state_est_battery_range",chargingState:"sensor:charge_state_charging_state",chargerPower:"sensor:charge_state_charger_power",chargeLimit:"number:charge_state_charge_limit_soc",timeToFull:"sensor:charge_state_minutes_to_full_charge",cableConnected:"binary_sensor:charge_state_conn_charge_cable",speed:"sensor:drive_state_speed",shiftState:"sensor:drive_state_shift_state",odometer:"sensor:vehicle_state_odometer",insideTemp:"sensor:climate_state_inside_temp",outsideTemp:"sensor:climate_state_outside_temp",online:"binary_sensor:state",locked:"lock:vehicle_state_locked",location:"device_tracker:location",route:"device_tracker:route",destination:"sensor:drive_state_active_route_destination",arrivalTime:"sensor:drive_state_active_route_minutes_to_arrival",distanceToArrival:"sensor:drive_state_active_route_miles_to_arrival",chargeAtArrival:"sensor:drive_state_active_route_energy_at_arrival",chargeSwitch:"switch:charge_state_charging_state",sentry:"switch:vehicle_state_sentry_mode",climate:"climate:driver_temp",frunk:"cover:vehicle_state_ft",trunk:"cover:vehicle_state_rt",windows:"cover:windows",wake:"button:wake"};function kt(t){const e="string"==typeof t?t.indexOf("."):-1;return e>0?t.slice(0,e):null}function Et(t){if(!t?.entities||!t?.devices)return[];const e=new Set;for(const i of Object.values(t.entities))i.platform===St&&i.device_id&&`${kt(i.entity_id)}:${i.translation_key}`===xt.battery&&e.add(i.device_id);return[...e].filter(e=>t.devices[e])}function Pt(t,e){if(!e)return null;const i=t?.states?.[e];return i?"unavailable"===i.state||"unknown"===i.state?null:i:null}function Ct(t,e){const i=Pt(t,e);if(!i)return null;const n=Number(i.state);return Number.isFinite(n)?n:null}function Mt(t,e){return t?.states?.[e]?.attributes?.unit_of_measurement??null}const Tt="asleep",Nt="charging",Ut="driving",Ot=new Set(["charging","starting"]),Rt=new Set(["d","r","n"]);function Bt(t,e){const i=Ct(t,e.battery)??Ct(t,e.batteryUsable),n=Ct(t,e.speed),s=Pt(t,e.shiftState)?.state??null,r=Pt(t,e.chargingState)?.state??null,o=Pt(t,e.online)?.state??null,a=Ot.has(r);let l;l=Rt.has(s??"")||null!==n&&n>0?Ut:a?Nt:"on"===o||null===o?"parked":Tt;const c=function(t,e){const i=Pt(t,e.arrivalTime)?.state??null,n=Ct(t,e.distanceToArrival);return i||null!==n?{destination:Pt(t,e.destination)?.state??null,destinationEntityMissing:!e.destination,arrival:i,distance:n,distanceUnit:Mt(t,e.distanceToArrival),chargeAtArrival:Ct(t,e.chargeAtArrival)}:null}(t,e);return{status:l,battery:i,range:Ct(t,e.range)??Ct(t,e.rangeEstimated),rangeUnit:Mt(t,e.range)??Mt(t,e.rangeEstimated),speed:n,speedUnit:Mt(t,e.speed),chargeLimit:Ct(t,e.chargeLimit),chargerPower:Ct(t,e.chargerPower),timeToFull:Pt(t,e.timeToFull)?.state??null,locked:Ht(t,e),zone:Dt(t,e),route:c}}function Ht(t,e){const i=Pt(t,e.locked);return i?"locked"===i.state:null}function Dt(t,e){const i=Pt(t,e.location);if(!i)return null;const n=i.state;return"not_home"===n?null:"home"===n?"Home":n}const zt=I`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 17a2 2 0 0 0 2-2 2 2 0 0 0-2-2 2 2 0 0 0-2 2 2 2 0 0 0 2 2m6-9a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V10a2 2 0 0 1 2-2h1V6a5 5 0 0 1 5-5 5 5 0 0 1 5 5v2h1M12 3a3 3 0 0 0-3 3v2h6V6a3 3 0 0 0-3-3Z"/></svg>`,jt=I`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M18 8h-1V6A5 5 0 0 0 7 6h1.9A3.1 3.1 0 0 1 15 6v2H6a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V10a2 2 0 0 0-2-2m-6 9a2 2 0 1 1 0-4 2 2 0 0 1 0 4Z"/></svg>`,Lt=I`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 11.5A2.5 2.5 0 0 1 9.5 9 2.5 2.5 0 0 1 12 6.5 2.5 2.5 0 0 1 14.5 9a2.5 2.5 0 0 1-2.5 2.5M12 2a7 7 0 0 0-7 7c0 5.25 7 13 7 13s7-7.75 7-13a7 7 0 0 0-7-7Z"/></svg>`,Ft=I`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M11 15H6l7-14v8h5l-7 14v-8Z"/></svg>`,It=I`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2a1 1 0 0 1 1 1v7.27a3 3 0 1 1-2 0V3a1 1 0 0 1 1-1m0 3.5a2.5 2.5 0 0 0-2.5 2.5v4.6a4.5 4.5 0 1 0 5 0V8A2.5 2.5 0 0 0 12 5.5Z"/></svg>`,Wt=I`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 9a3 3 0 0 0-3 3 3 3 0 0 0 3 3 3 3 0 0 0 3-3 3 3 0 0 0-3-3m0 8a5 5 0 0 1-5-5 5 5 0 0 1 5-5 5 5 0 0 1 5 5 5 5 0 0 1-5 5m0-12.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5Z"/></svg>`,Vt=I`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M16.56 5.44 15.11 6.89A6 6 0 1 1 8.89 6.9L7.44 5.44a8 8 0 1 0 9.12 0M13 3h-2v10h2Z"/></svg>`,Yt="renders";function Zt(t={}){const{openDatabase:e=qt,fetchImage:i=Gt,createObjectUrl:n=t=>URL.createObjectURL(t),revokeObjectUrl:s=t=>URL.revokeObjectURL(t)}=t,r=new Map,o=new Map;async function a(t){const i=await e();if(i)return ee(i,[t])}return{resolve:async function(t){if(!t)return null;if(r.has(t))return r.get(t);if(o.has(t))return o.get(t);const s=(async()=>{let s=await async function(t){const i=await e();return i?Jt(i,t):null}(t).catch(()=>null);if(s&&!Kt(s)&&(s=null,await a(t).catch(()=>{})),s||(s=await i(t).catch(()=>null),s&&Kt(s)&&await async function(t,i){const n=await e();if(!n)return;return Qt(n,t,i)}(t,s).catch(()=>{}),s&&!Kt(s)&&(s=null)),!s)return null;const o=n(s);return r.set(t,o),o})();o.set(t,s);try{return await s}finally{o.delete(t)}},prune:async function(t){const i=new Set(t.filter(Boolean));for(const[t,e]of r)i.has(t)||(s(e),r.delete(t));try{const t=await e();if(!t)return;const n=(await te(t)).filter(t=>!i.has(t));n.length&&await ee(t,n)}catch{}},release:function(){for(const t of r.values())s(t);r.clear()},evict:async function(t){const e=r.get(t);e&&(s(e),r.delete(t)),o.delete(t),await a(t).catch(()=>{})}}}function qt(){return new Promise(t=>{if("undefined"==typeof indexedDB)return t(null);let e;try{e=indexedDB.open("tesla-card",1)}catch{return t(null)}e.onupgradeneeded=()=>{const t=e.result;t.objectStoreNames.contains(Yt)||t.createObjectStore(Yt)},e.onsuccess=()=>t(e.result),e.onerror=()=>t(null),e.onblocked=()=>t(null)})}function Kt(t){return!(!t||"number"!=typeof t.size)&&(!(t.size<512)&&("string"==typeof t.type&&t.type.startsWith("image/")))}async function Gt(t){const e=await fetch(t,{mode:"cors",credentials:"omit"});if(!e.ok)throw new Error(`image request failed: ${e.status}`);const i=e.headers?.get?.("content-type")??"";if(!i.startsWith("image/"))throw new Error(`not an image: ${i||"no content-type"}`);return e.blob()}function Xt(t,e,i){return new Promise((n,s)=>{let r;try{r=t.transaction(Yt,e)}catch(t){return s(t)}const o=i(r.objectStore(Yt));r.onabort=()=>s(r.error),r.onerror=()=>s(r.error),o?(o.onsuccess=()=>n(o.result),o.onerror=()=>s(o.error)):r.oncomplete=()=>n()})}const Jt=(t,e)=>Xt(t,"readonly",t=>t.get(e)),Qt=(t,e,i)=>Xt(t,"readwrite",t=>t.put(i,e)),te=t=>Xt(t,"readonly",t=>t.getAllKeys());function ee(t,e){return Xt(t,"readwrite",t=>{for(const i of e)t.delete(i);return null})}const ie=.621371192,ne=1.609344,se={mi:{to:"km",factor:ne},km:{to:"mi",factor:ie}},re={mph:{to:"km/h",factor:ne},"km/h":{to:"mph",factor:ie}},oe="auto",ae="imperial",le=new Set(["mi","mph"]),ce=new Set(["km","km/h"]);function he(t,e,i=oe,n="distance"){const s=function(t){if("string"!=typeof t)return null;const e=t.trim();if(!e)return null;const i=e.toLowerCase();return"mi"===i||"miles"===i||"mile"===i?"mi":"km"===i||"kilometers"===i||"kilometres"===i?"km":"mph"===i||"mi/h"===i?"mph":"km/h"===i||"kph"===i||"kmh"===i?"km/h":e}(e);if(null==t)return{value:null,unit:s};if(i===oe||!s)return{value:t,unit:s};if((i===ae?le:ce).has(s))return{value:t,unit:s};const r=("speed"===n?re:se)[s];return r?{value:t*r.factor,unit:r.to}:{value:t,unit:s}}function de(t,e){if(!e)return null;const i=t?.states?.[e]?.attributes;if(!i)return null;const{latitude:n,longitude:s}=i;return"number"!=typeof n||"number"!=typeof s?null:Number.isFinite(n)&&Number.isFinite(s)?[n,s]:null}const ue="never",pe="always";function me(t){return!1===t||t===ue?ue:t===pe?pe:"navigating"}class fe extends at{static properties={hass:{attribute:!1},_config:{state:!0},_imageFailed:{state:!0},_trail:{state:!0},_cachedSrc:{state:!0}};static styles=ct;constructor(){super(),this._imageFailed=!1,this._trail=null,this._unsubscribeHistory=null,this._trailFor=null,this._cachedSrc=null,this._cachedFor=null,this._retried=new Set,this._images=Zt()}setConfig(t){if(void 0!==t.device_id&&"string"!=typeof t.device_id)throw new Error("device_id must be the id of a Tesla Fleet vehicle");this._config={view:"FRONT34",controls:!1,map:"navigating",trail:!0,...t},ft.includes(this._config.view)||(this._config.view="FRONT34"),this._imageFailed=!1}disconnectedCallback(){super.disconnectedCallback(),this._stopHistory(),this._images.release(),this._cachedSrc=null,this._cachedFor=null}getCardSize(){return me(this._config?.map)===pe?8:5}getGridOptions(){return{columns:12,min_columns:6}}static getStubConfig(t){return{device_id:Et(t)[0]??""}}static getConfigForm(){return{schema:[{name:"device_id",required:!0,selector:{device:{filter:{integration:"tesla_fleet"}}}},{type:"grid",name:"",flatten:!0,schema:[{name:"paint",selector:{select:{mode:"dropdown",options:_e}}},{name:"wheels",selector:{select:{mode:"dropdown",options:ve}}}]},{type:"expandable",name:"advanced",title:"More options",flatten:!0,schema:[{type:"grid",name:"",flatten:!0,schema:[{name:"trail",selector:{boolean:{}}},{name:"controls",selector:{boolean:{}}},{name:"performance",selector:{boolean:{}}}]},{name:"view",selector:{select:{mode:"dropdown",options:ft.map(t=>({value:t,label:t}))}}},{name:"map",selector:{select:{mode:"dropdown",options:[{value:"navigating",label:"Only while navigating"},{value:"always",label:"Always"},{value:"never",label:"Never"}]}}},{name:"units",selector:{select:{mode:"dropdown",options:[{value:"auto",label:"Follow Home Assistant"},{value:"imperial",label:"Miles"},{value:"metric",label:"Kilometres"}]}}},{name:"drive_hand",selector:{select:{mode:"dropdown",options:[{value:"auto",label:"From your country setting"},{value:"lhd",label:"Left-hand drive"},{value:"rhd",label:"Right-hand drive"}]}}},{name:"name",selector:{text:{}}},{name:"image",selector:{text:{}}},{name:"options_override",selector:{text:{}}}]}],computeLabel:t=>$e[t.name],computeHelper:t=>we[t.name]}}render(){if(!this._config||!this.hass)return V;const t=this._config.device_id,e=t?this.hass.devices?.[t]:null;if(!e)return this._shell("Tesla",V,F`<div class="notice">
      ...
      <ha-card>
        ...
        ${this._hero(s,n)}
        <div class="strip">
          ${this._readout(n)} ${o?F`<span class="age">${o}</span>`:V}
        </div>
        ${this._gauge(n)} ${this._place(n,a)}
        ${l?this._map(i,a):V}
        ${this._config.controls?this._controls(i,n):V}
        ${this._notices(s,a)}
      </ha-card>
    `}_shell(t,e,i){return F`<ha-card>
      <div class="head"><div class="name">${t}</div></div>
      ${e}${i}
    </ha-card>`}_status(t){const e={[Tt]:"Asleep",[Nt]:"Charging",[Ut]:"Driving",parked:"Parked"},i=!1===t.locked&&t.status!==Ut,n=["status",t.status,i?"unlocked":""].join(" ");return F`<span class=${n}>
      ${!1===t.locked?jt:zt}
      ...
      </div>`;const s=(r=this._config.view,bt[r]??bt.FRONT34);var r;const o=`aspect-ratio:${s.aspect}`,a=`width:${100*s.width}%;left:${100*s.left}%;top:${100*s.top}%`;return F`<div class="hero ${e.status===Tt?"asleep":""}" style=${o}>
      <img
        src=${n}
        alt=${t?.name??"Tesla"}
        style=${a}
    ...
    `}_gauge(t){const e=t.battery??0,i=["fill",t.status===Nt?"charging":"",t.status===Tt?"asleep":"",t.status!==Nt&&e<=20?"low":""].join(" "),n=t.chargeLimit;return F`<div class="gauge">
      ...
      .zoom=${13}
      .clusterMarkers=${!1}
    ></ha-map>`}_controls(t,e){const i=Pt(this.hass,t.climate),n=i?.attributes?.temperature,s=[t.locked&&{id:"lock",icon:!1===e.locked?jt:zt,label:!1===e.locked?"Unlocked":"Locked",entity:t.locked,domain:"lock",tone:!1===e.locked?"warn":null},t.chargeSwitch&&{id:"charge",icon:Ft,label:e.status===Nt?"Charging":"Charge",entity:t.chargeSwitch,domain:"switch",tone:e.status===Nt?"ok":null},t.climate&&{id:"climate",icon:It,label:i&&"off"!==i.state?void 0!==n?`${Math.round(n)}°`:"On":"Climate",entity:t.climate,domain:"climate",tone:i&&"off"!==i.state?"on":null},t.sentry&&{id:"sentry",icon:Wt,label:"Sentry",entity:t.sentry,domain:"switch",tone:"on"===Pt(this.hass,t.sentry)?.state?"on":null},t.wake&&{id:"wake",icon:Vt,label:"Wake",entity:t.wake,domain:"button",tone:null}].filter(Boolean);return s.length?F`<div class="controls">
      ${s.map(t=>F`<button
            type="button"
          ...
          headed by name.`),i.length?F`${i.map(t=>F`<div class="notice">${t}</div>`)}`:V}_syncHistory(t){if(this._trailFor===t)return;if(this._trailFor=t,this._stopHistory(),this._trail=null,!t||!this.hass?.connection)return;const e=new Date(Date.now()-72e5).toISOString();this.hass.connection.subscribeMessage(e=>{const i=e?.states?.[t];if(!i)return;const n=i.map(t=>{const e=t.a??t.attributes??{},i=e.latitude,n=e.longitude;if("number"!=typeof i||"number"!=typeof n)return null;const s=t.lu??t.last_updated;return"number"!=typeof s?null:{point:[i,n],timestamp:new Date(1e3*s)}}).filter(Boolean);n.length&&(this._trail=n)},{type:"history/stream",entity_ids:[t],start_time:e,minimal_response:!0,no_attributes:!1}).then(t=>{this._unsubscribeHistory=t}).catch(()=>{this._trail=null})}_stopHistory(){if(this._unsubscribeHistory){try{this._unsubscribeHistory()}catch{}this._unsubscribeHistory=null}}_clock(t){const e=new Date(t);if(Number.isNaN(e.getTime()))return"";try{return e.toLocaleTimeString(this.hass?.locale?.language??void 0,{hour:"2-digit",minute:"2-digit"})}catch{return e.toISOString().slice(11,16)}}}function ge(t){return Math.min(100,Math.max(0,Number(t)||0))}const _e=ye(wt("my","juniper").concat(wt("my","legacy"))),ve=ye($t("my","juniper",!0).concat($t("my","legacy",!0)));function ye(t){const e=new Map;for(const i of t)e.has(i.id)||e.set(i.id,i.name);return[...e].map(([t,e])=>({value:t,label:e}))}const $e={device_id:"Vehicle",paint:"Paint",wheels:"Wheels",view:"Angle",map:"Show a map",trail:"Draw where it has been",controls:"Show controls",performance:"Performance model",units:"Distance and speed",drive_hand:"Steering wheel",name:"Name",image:"Image URL",options_override:"Configurator options"},we={device_id:"The card reads the model, year and body from this vehicle.",paint:"Not reported by the integration, so pick your colour here.",wheels:"Not reported by the integration, so pick your wheels here.",units:"Home Assistant treats the UK as metric, so set this to miles if you want road units.",map:"Showing it only while navigating keeps the card small the rest of the time.",performance:"Needed before the configurator will render the larger wheels.",image:"Show your own picture instead of the configurator render.",options_override:"Raw option string, for a configuration the dropdowns do not cover."},be="tesla-fleet-card";customElements.get(be)||customElements.define(be,fe),window.customCards=window.customCards||[],window.customCards.some(t=>t.type===be)||window.customCards.push({type:be,name:"Tesla Card",description:"Battery, range and status for a vehicle on the Tesla Fleet integration.",preview:!0,documentationURL:"https://github.com/alexluckett/tesla-card"});export{fe as TeslaFleetCard};
