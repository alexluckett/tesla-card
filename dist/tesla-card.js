...
`,ht={S:{model:"ms",name:"Model S"},X:{model:"mx",name:"Model X"},3:{model:"m3",name:"Model 3"},Y:{model:"my",name:"Model Y"},C:{model:"ct",name:"Cybertruck"},R:{model:"mr",name:"Roadster"},T:{model:"ms",name:"Semi"},A:{model:"my",name:"Cybercab"}},dt={L:2020,M:2021,N:2022,P:2023,R:2024,S:2025,T:2026,V:2027,W:2028,X:2029,Y:2030},ut={my:{year:2025,current:"juniper",previous:"legacy"},m3:{year:2024,current:"highland",previous:"legacy"},ms:{year:2021,current:"palladium",previous:"legacy"},mx:{year:2021,current:"palladium",previous:"legacy"}},pt=new Set(["GB","IE","AU","NZ","JP","IN","ZA","SG","MY","TH","HK","ID","PK","LK","KE","CY","MT"]);function mt(t,e){const i=ut[t];return i?null===e||e>=i.year?i.current:i.previous:null}const ft=["FRONT34","STUD_3QTR","SIDE","STUD_SIDE","REAR34","STUD_REAR"],gt={my:{juniper:{label:"Model Y (2025 onwards)",trim:"$MTY86",performanceTrim:"$MTY53",interior:"$IPB12",performanceInterior:"$IPB14",paints:[{id:"stealth_grey",code:"$PN01",name:"Stealth Grey",swatch:"#494955"},{id:"pearl_white",code:"$PPSW",name:"Pearl White",swatch:"#e7e8ec"},{id:"diamond_black",code:"$PBSB",name:"Diamond Black",swatch:"#262629"},{id:"deep_blue",code:"$PPSB",name:"Deep Blue Metallic",swatch:"#113683"},{id:"ultra_red",code:"$PR01",name:"Ultra Red",swatch:"#a7111f"},{id:"quicksilver",code:"$PN00",name:"Quicksilver",swatch:"#97969f"},{id:"glacier_blue",code:"$PB01",name:"Glacier Blue",swatch:"#6e84a4"},{id:"navy_pb02",code:"$PB02",name:"Dark Blue (PB02)",swatch:"#2a3650"}],wheels:[{id:"crossflow_19",code:"$WY19P",name:'19" Crossflow'},{id:"helix_20",code:"$WY20B",name:'20" Helix 2.0'},{id:"induction_20",code:"$WY20A",name:'20" Induction'},{id:"performance_21",code:"$WY21A",name:'21" Performance',performanceOnly:!0}]},legacy:{label:"Model Y (2020 to 2024)",trim:"$MDLY,$MTY01",interior:"$INPB0",paints:[{id:"pearl_white",code:"$PPSW",name:"Pearl White",swatch:"#e7e8ec"},{id:"solid_black",code:"$PBSB",name:"Solid Black",swatch:"#262629"},{id:"midnight_silver",code:"$PMNG",name:"Midnight Silver",swatch:"#5b6065"},{id:"deep_blue",code:"$PPSB",name:"Deep Blue Metallic",swatch:"#113683"},{id:"red_multicoat",code:"$PPMR",name:"Red Multi-Coat",swatch:"#a51d2c"}],wheels:[{id:"gemini_19",code:"$WY19B",name:'19" Gemini'},{id:"induction_20",code:"$WY20P",name:'20" Induction'}]}},m3:{legacy:{label:"Model 3",trim:"$MDL3,$MT300",interior:"$IN3PB",paints:[{id:"pearl_white",code:"$PPSW",name:"Pearl White",swatch:"#e7e8ec"},{id:"solid_black",code:"$PBSB",name:"Solid Black",swatch:"#262629"},{id:"midnight_silver",code:"$PMNG",name:"Midnight Silver",swatch:"#5b6065"},{id:"deep_blue",code:"$PPSB",name:"Deep Blue Metallic",swatch:"#113683"},{id:"red_multicoat",code:"$PPMR",name:"Red Multi-Coat",swatch:"#a51d2c"}],wheels:[{id:"aero_18",code:"$W38B",name:'18" Aero'}]}}};function _t(t,e){return vt(t,e)?.wheels[0]?.id??null}function vt(t,e){const i=gt[t];return i?e&&i[e]?i[e]:Object.values(i)[0]??null:null}function $t(t,e){return null!==vt(t,e)}function yt(t,e,i=!1){const n=vt(t,e);return n?n.wheels.filter(t=>i||!t.performanceOnly):[]}function wt(t,e){return vt(t,e)?.paints??[]}const bt={FRONT34:{width:1.613,left:-.316,top:-.503,aspect:2.273},STUD_3QTR:{width:1.613,left:-.316,top:-.503,aspect:2.273},REAR34:{width:1.613,left:-.316,top:-.503,aspect:2.273},SIDE:{width:1.53,left:-.27,top:-.47,aspect:2.5},STUD_SIDE:{width:1.53,left:-.27,top:-.47,aspect:2.5},STUD_REAR:{width:1.613,left:-.316,top:-.503,aspect:2.273}};function At(t,e){return t.find(t=>t.id===e)??null}const St="tesla_fleet",xt={battery:"charge_state_battery_level",batteryUsable:"charge_state_usable_battery_level",range:"charge_state_battery_range",rangeEstimated:"charge_state_est_battery_range",chargingState:"charge_state_charging_state",chargerPower:"charge_state_charger_power",chargeLimit:"charge_state_charge_limit_soc",timeToFull:"charge_state_minutes_to_full_charge",cableConnected:"charge_state_conn_charge_cable",speed:"drive_state_speed",shiftState:"drive_state_shift_state",odometer:"vehicle_state_odometer",insideTemp:"climate_state_inside_temp",outsideTemp:"climate_state_outside_temp",online:"state",locked:"vehicle_state_locked",location:"location",route:"route",destination:"drive_state_active_route_destination",arrivalTime:"drive_state_active_route_minutes_to_arrival",distanceToArrival:"drive_state_active_route_miles_to_arrival",chargeAtArrival:"drive_state_active_route_energy_at_arrival",sentry:"vehicle_state_sentry_mode",climate:"driver_temp",frunk:"vehicle_state_ft",trunk:"vehicle_state_rt",windows:"windows",wake:"wake"};function kt(t){if(!t?.entities||!t?.devices)return[];const e=new Set;for(const i of Object.values(t.entities))i.platform===St&&i.device_id&&i.translation_key===xt.battery&&e.add(i.device_id);return[...e].filter(e=>t.devices[e])}function Et(t,e){if(!e)return null;const i=t?.states?.[e];return i?"unavailable"===i.state||"unknown"===i.state?null:i:null}function Pt(t,e){const i=Et(t,e);if(!i)return null;const n=Number(i.state);return Number.isFinite(n)?n:null}function Mt(t,e){return t?.states?.[e]?.attributes?.unit_of_measurement??null}const Tt="asleep",Ct="charging",Ut="driving",Rt=new Set(["charging","starting"]),Nt=new Set(["d","r","n"]);function Ot(t,e){const i=Pt(t,e.battery)??Pt(t,e.batteryUsable),n=Pt(t,e.speed),s=Et(t,e.shiftState)?.state??null,r=Et(t,e.chargingState)?.state??null,a=Et(t,e.online)?.state??null,o=Rt.has(r);let l;l=Nt.has(s??"")||null!==n&&n>0?Ut:o?Ct:"on"===a||null===a?"parked":Tt;const c=function(t,e){const i=Et(t,e.arrivalTime)?.state??null,n=Pt(t,e.distanceToArrival);return i||null!==n?{destination:Et(t,e.destination)?.state??null,destinationAvailable:Boolean(e.destination),arrival:i,distance:n,distanceUnit:Mt(t,e.distanceToArrival),chargeAtArrival:Pt(t,e.chargeAtArrival)}:null}(t,e);return{status:l,battery:i,range:Pt(t,e.range)??Pt(t,e.rangeEstimated),rangeUnit:Mt(t,e.range)??Mt(t,e.rangeEstimated),speed:n,speedUnit:Mt(t,e.speed),chargeLimit:Pt(t,e.chargeLimit),chargerPower:Pt(t,e.chargerPower),timeToFull:Et(t,e.timeToFull)?.state??null,locked:Bt(t,e),zone:Ht(t,e),route:c}}function Bt(t,e){const i=Et(t,e.locked);return i?"locked"===i.state:null}function Ht(t,e){const i=Et(t,e.location);if(!i)return null;const n=i.state;return"not_home"===n?null:"home"===n?"Home":n}const Dt={lock:F`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 17a2 2 0 0 0 2-2 2 2 0 0 0-2-2 2 2 0 0 0-2 2 2 2 0 0 0 2 2m6-9a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V10a2 2 0 0 1 2-2h1V6a5 5 0 0 1 5-5 5 5 0 0 1 5 5v2h1M12 3a3 3 0 0 0-3 3v2h6V6a3 3 0 0 0-3-3Z"/></svg>`,lockOpen:F`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M18 8h-1V6A5 5 0 0 0 7 6h1.9A3.1 3.1 0 0 1 15 6v2H6a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V10a2 2 0 0 0-2-2m-6 9a2 2 0 1 1 0-4 2 2 0 0 1 0 4Z"/></svg>`,pin:F`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 11.5A2.5 2.5 0 0 1 9.5 9 2.5 2.5 0 0 1 12 6.5 2.5 2.5 0 0 1 14.5 9a2.5 2.5 0 0 1-2.5 2.5M12 2a7 7 0 0 0-7 7c0 5.25 7 13 7 13s7-7.75 7-13a7 7 0 0 0-7-7Z"/></svg>`,bolt:F`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M11 15H6l7-14v8h5l-7 14v-8Z"/></svg>`,climate:F`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2a1 1 0 0 1 1 1v7.27a3 3 0 1 1-2 0V3a1 1 0 0 1 1-1m0 3.5a2.5 2.5 0 0 0-2.5 2.5v4.6a4.5 4.5 0 1 0 5 0V8A2.5 2.5 0 0 0 12 5.5Z"/></svg>`,wake:F`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M16.56 5.44 15.11 6.89A6 6 0 1 1 8.89 6.9L7.44 5.44a8 8 0 1 0 9.12 0M13 3h-2v10h2Z"/></svg>`},zt="renders";function jt(t={}){const{openDatabase:e=It,fetchImage:i=Ft,createObjectUrl:n=t=>URL.createObjectURL(t),revokeObjectUrl:s=t=>URL.revokeObjectURL(t)}=t,r=new Map,a=new Map;async function o(t){const i=await e();if(i)return qt(i,[t])}return{resolve:async function(t){if(!t)return null;if(r.has(t))return r.get(t);if(a.has(t))return a.get(t);const s=(async()=>{let s=await async function(t){const i=await e();return i?Yt(i,t):null}(t).catch(()=>null);if(s&&!Lt(s)&&(s=null,await o(t).catch(()=>{})),s||(s=await i(t).catch(()=>null),s&&Lt(s)&&await async function(t,i){const n=await e();if(!n)return;return Vt(n,t,i)}(t,s).catch(()=>{}),s&&!Lt(s)&&(s=null)),!s)return null;const a=n(s);return r.set(t,a),a})();a.set(t,s);try{return await s}finally{a.delete(t)}},prune:async function(t){const i=new Set(t.filter(Boolean));for(const[t,e]of r)i.has(t)||(s(e),r.delete(t));try{const t=await e();if(!t)return;const n=(await Zt(t)).filter(t=>!i.has(t));n.length&&await qt(t,n)}catch{}},release:function(){for(const t of r.values())s(t);r.clear()},evict:async function(t){const e=r.get(t);e&&(s(e),r.delete(t)),a.delete(t),await o(t).catch(()=>{})}}}function It(){return new Promise(t=>{if("undefined"==typeof indexedDB)return t(null);let e;try{e=indexedDB.open("tesla-card",1)}catch{return t(null)}e.onupgradeneeded=()=>{const t=e.result;t.objectStoreNames.contains(zt)||t.createObjectStore(zt)},e.onsuccess=()=>t(e.result),e.onerror=()=>t(null),e.onblocked=()=>t(null)})}function Lt(t){return!(!t||"number"!=typeof t.size)&&(!(t.size<512)&&("string"==typeof t.type&&t.type.startsWith("image/")))}async function Ft(t){const e=await fetch(t,{mode:"cors",credentials:"omit"});if(!e.ok)throw new Error(`image request failed: ${e.status}`);const i=e.headers?.get?.("content-type")??"";if(!i.startsWith("image/"))throw new Error(`not an image: ${i||"no content-type"}`);return e.blob()}function Wt(t,e,i){return new Promise((n,s)=>{let r;try{r=t.transaction(zt,e)}catch(t){return s(t)}const a=i(r.objectStore(zt));r.onabort=()=>s(r.error),r.onerror=()=>s(r.error),a?(a.onsuccess=()=>n(a.result),a.onerror=()=>s(a.error)):r.oncomplete=()=>n()})}const Yt=(t,e)=>Wt(t,"readonly",t=>t.get(e)),Vt=(t,e,i)=>Wt(t,"readwrite",t=>t.put(i,e)),Zt=t=>Wt(t,"readonly",t=>t.getAllKeys());function qt(t,e){return Wt(t,"readwrite",t=>{for(const i of e)t.delete(i);return null})}class Gt extends ot{static properties={hass:{attribute:!1},_config:{state:!0},_imageFailed:{state:!0},_trail:{state:!0},_cachedSrc:{state:!0}};static styles=ct;constructor(){super(),this._imageFailed=!1,this._trail=null,this._unsubscribeHistory=null,this._trailFor=null,this._cachedSrc=null,this._cachedFor=null,this._retried=new Set,this._images=jt()}setConfig(t){if(void 0!==t.device_id&&"string"!=typeof t.device_id)throw new Error("device_id must be the id of a Tesla Fleet vehicle");this._config={view:"FRONT34",controls:!1,map:!0,trail:!0,...t},ft.includes(this._config.view)||(this._config.view="FRONT34"),this._imageFailed=!1}disconnectedCallback(){super.disconnectedCallback(),this._stopHistory(),this._images.release(),this._cachedSrc=null,this._cachedFor=null}getCardSize(){return this._showMap()?8:5}getGridOptions(){return{rows:this._showMap()?8:5,columns:12,min_columns:6,min_rows:4}}static getStubConfig(t){return{device_id:kt(t)[0]??""}}static getConfigForm(){return{schema:[{name:"device_id",required:!0,selector:{device:{filter:{integration:"tesla_fleet"}}}},{type:"grid",name:"",flatten:!0,schema:[{name:"paint",selector:{select:{mode:"dropdown",options:Xt}}},{name:"wheels",selector:{select:{mode:"dropdown",options:Jt}}}]},{type:"expandable",name:"advanced",title:"More options",flatten:!0,schema:[{type:"grid",name:"",flatten:!0,schema:[{name:"map",selector:{boolean:{}}},{name:"trail",selector:{boolean:{}}},{name:"controls",selector:{boolean:{}}},{name:"performance",selector:{boolean:{}}}]},{name:"view",selector:{select:{mode:"dropdown",options:ft.map(t=>({value:t,label:t}))}}},{name:"drive_hand",selector:{select:{mode:"dropdown",options:[{value:"auto",label:"From your country setting"},{value:"lhd",label:"Left-hand drive"},{value:"rhd",label:"Right-hand drive"}]}}},{name:"name",selector:{text:{}}},{name:"image",selector:{text:{}}},{name:"options_override",selector:{text:{}}}]}],computeLabel:t=>te[t.name],computeHelper:t=>ee[t.name]}}render(){if(!this._config||!this.hass)return Y;const t=this._config.device_id,e=t?this.hass.devices?.[t]:null;if(!e)return this._shell("Tesla",Y,L`<div class="notice">
      ...
      <ha-card>
        ...
        ${this._hero(s,n)}
        <div class="strip">
          ${this._readout(n)} ${a?L`<span class="age">${a}</span>`:Y}
        </div>
    ...
    `}_shell(t,e,i){return L`<ha-card>
      <div class="head"><div class="name">${t}</div></div>
      ${e}${i}
    </ha-card>`}_status(t){const e={[Tt]:"Asleep",[Ct]:"Charging",[Ut]:"Driving",parked:"Parked"},i=!1===t.locked&&t.status!==Ut,n=["status",t.status,i?"unlocked":""].join(" ");return L`<span class=${n}>
      ${!1===t.locked?Dt.lockOpen:Dt.lock}
      <span>${e[t.status]??"Parked"}</span>
    </span>`}_hero(t,e){const i=this._imageSource(t,e);this._syncImage(i);const n=this._cachedFor===i&&this._cachedSrc?this._cachedSrc:i;if(!n)return L`<div class="hero blank">
        ${t?`No configurator artwork for the ${t.name} yet.`:"Waiting for the vehicle to report."}
      </div>`;const s=(r=this._config.view,bt[r]??bt.FRONT34);var r;const a=`aspect-ratio:${s.aspect}`,o=`width:${100*s.width}%;left:${100*s.left}%;top:${100*s.top}%`;return L`<div class="hero ${e.status===Tt?"asleep":""}" style=${a}>
      <img
        src=${n}
        alt=${t?.name??"Tesla"}
        style=${o}
